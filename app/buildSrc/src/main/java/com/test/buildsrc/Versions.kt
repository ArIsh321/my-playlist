...
object Versions {
    const val BUILD_GRADLE_VERSION = "7.2.1"
    ...
    const val ANDROID_COMMON_KTX_VERSION = "1.0.1"
    ...
    const val ANDROIDX_COORDINATOR_LAYOUT_VERSION = "1.2.0"
    ...
    const val ANDROIDX_SUPPORT_VERSION = "1.4.2"
    const val ANDROIDX_ROOM_VERSION = "2.4.3"
    ...
    const val CIRCULAR_IMAGEVIEW_VERSION = "4.3.0"

    const val DOTS_INDICATOR_VERSION = "4.2"
    const val EXOPLAYER_VERSION = "2.16.1"
    const val FIREBASE_BOOM = "29.3.1"
    const val FIREBASE_CRASHLYTICS_GRADLE = "2.8.1"
    const val GOOGLE_SERVICES = "4.3.10"

    const val GLIDE_VERSION = "4.11.0"
    const val GOOGLE_SERVICE_LOCATION = "17.1.0"
    const val HILT_VERSION = "2.38.1"

    const val IMAGE_PICKER_VERSION  ="2.1"
    const val IMAGE_CROPPER_VERSION = "2.2.2"
    ...
    const val MASKED_EDIT_TEXT_VERSION = "4.0.7"
    const val MOSHI_VERSION = "1.12.0"
    const val MAVEN_PLUGIN = "2.1"
    const val MATERIAL_SEARCH_VIEW = "1.6.0"

    const val OKHTTP_VERSION = "4.9.1"
    const val RETROFIT_VERSION = "2.9.0"
    const val RETROFIT_KOTLIN_COROUTINES_VERSION = "0.9.2"
